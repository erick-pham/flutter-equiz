...
/// You simply need to put in the colors you wish to use, and it will generate all shades
/// for you. Your primary colors will be the `500` value.
///
/// colors Creation:
/// In order to create the custom colors you need to create a `Map<int, Color>` object
/// which will have all the shade values. `const Color(0xFF...)` will be how you create
/// the colors. The six character hex code is what follows. If you wanted the colors
